...
public class MousePanel implements MouseListener {
	...
	public MousePanel(Menu menu, Difficulty difficulty, GameOver gameOver,Win win, Pause pause,Help help, Controller controller) {
		this.menu = menu;
...
//					Game.state = STATE.DIFF;
//				}
//			}else if (px >= menu.helpButton.getMinX() && px <= menu.helpButton.getMaxX()) {
//				if (py >= menu.helpButton.getMinY() && py <= menu.helpButton.getMaxY()) {
//					System.out.println("HELP BUTTON");
//					// Game.state = Game.state.GAME;
//				}
//			}else if (px >= menu.quitButton.getMinX() && px <= menu.quitButton.getMaxX()) {
//				if (py >= menu.quitButton.getMinY() && py <= menu.quitButton.getMaxY()) {
//					System.out.println("QUIT BUTTON");
//					// Game.state = Game.state.GAME;
//					System.exit(1);
...
//					controller.start();
//				}
//			}else if(px >= difficulty.mediumButton.getMinX() && px <= difficulty.mediumButton.getMaxX()) {
//				if (py >= difficulty.mediumButton.getMinY() && py <= difficulty.mediumButton.getMaxY()) {
//					System.out.println("MEDIUM BUTTON");
//					Game.state = STATE.GAME;
//					Game.diff = DIFFICULTY.MEDIUM;
//					controller.start();
//				}
//			}else if(px >= difficulty.hardButton.getMinX() && px <= difficulty.hardButton.getMaxX()) {
//				if (py >= difficulty.hardButton.getMinY() && py <= difficulty.hardButton.getMaxY()) {
//					System.out.println("HARD BUTTON");
//					Game.state = STATE.GAME;
//					Game.diff = DIFFICULTY.HARD;
...
//					controller.start();
//				}
//			}else if(px >= gameOver.menuButton.getMinX() && px <= gameOver.menuButton.getMaxX()) {
//				if (py >= gameOver.menuButton.getMinY() && py <= gameOver.menuButton.getMaxY()) {
//					System.out.println("MENU BUTTON");
//					Game.state = STATE.MENU;
//					Game.diff = DIFFICULTY.BASE;
//					controller.reset();
//				}
//			}else if(px >= gameOver.quitButton.getMinX() && px <= gameOver.quitButton.getMaxX()) {
//				if (py >= gameOver.quitButton.getMinY() && py <= gameOver.quitButton.getMaxY()) {
//					System.out.println("QUIT BUTTON");
//					System.exit(1);
//				}
...
//					controller.reset();
//				}
//			}else if(px >= win.quitButton.getMinX() && px <= win.quitButton.getMaxX()) {
//				if (py >= win.quitButton.getMinY() && py <= win.quitButton.getMaxY()) {
//					System.out.println("QUIT BUTTON");
//					System.exit(1);
//				}
...
//					Game.state = STATE.GAME;
//				}
//			}else if(px >= pause.helpButton.getMinX() && px <= pause.helpButton.getMaxX()) {
//				if (py >= pause.helpButton.getMinY() && py <= pause.helpButton.getMaxY()) {
//					System.out.println("Help BUTTON");
//					Game.state = STATE.MENU;
//					Game.diff = DIFFICULTY.BASE;
//					controller.reset();
//				}
//			}else if(px >= pause.menuButton.getMinX() && px <= pause.menuButton.getMaxX()) {
//				if (py >= pause.menuButton.getMinY() && py <= pause.menuButton.getMaxY()) {
//					System.out.println("QUIT BUTTON");
//					Game.state = STATE.MENU;
//					Game.diff = DIFFICULTY.BASE;
